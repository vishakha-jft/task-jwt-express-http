...
app.put('/employee/:id',(req,res)=>{updateemp(req,res,req.params.id)})
app.delete('/employee/:id',(req,res)=>{removeemp(req,res,req.params.id)})
app.post('/employee',(req,res)=>{createemp(req,res)})
